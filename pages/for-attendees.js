...
const secondary = `
The conference will be held at [Cafe Amanda](https://www.amanda.fi/), a historic building near the center of Helsinki.
`;
...
const ForAttendees = () => (
  <>
    ...
    <div className="grid--full">
      ...
      />
      <ul>
        <li>Blue star - Amanda, Eteläesplanadi 8 - Main venue</li>
        <li>
